...
describe('HighligthDirective', () => {
  ...
  it('should have three highligth elements', () => {
    const numElements = fixture.debugElement.queryAll(By.css('*[highligth]'));
    const elements = fixture.debugElement.queryAll(By.directive(HighligthDirective));
    const elementsSwithout = fixture.debugElement.queryAll(By.css('*:not([highligth])'));
    expect(numElements.length).toEqual(3);
    expect(elements.length).toEqual(4);
    expect(elementsSwithout.length).toEqual(2);
  });
